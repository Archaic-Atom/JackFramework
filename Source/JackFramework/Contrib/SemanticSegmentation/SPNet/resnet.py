...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes: int, planes: int, stride: int = 1,
                 dilation: int = 1, downsample: object = None,
                 previous_dilation: int = 1, norm_layer: object = None,
                 spm_on: bool = False) -> object:
        super().__init__()
...
class ResNet(nn.Module):
    ...
    def __init__(self, block: object, layers: object,
                 dilated: bool = False, multi_grid: bool = False,
                 deep_base: bool = True, norm_layer: object = nn.BatchNorm2d,
                 spm_on: bool = False):
    ...
    def _make_layer(self, block: object, planes: int, blocks: object,
                    stride: int = 1, dilation: int = 1, norm_layer: object = None,
                    multi_grid: bool = False) -> object:
        downsample = None
...
def resnet50(pretrained: str = None, **kwargs: dict) -> object:
...
def resnet101(pretrained: str = None, **kwargs: dict) -> object:
...
def resnet152(pretrained: str = None, **kwargs: dict) -> object:
