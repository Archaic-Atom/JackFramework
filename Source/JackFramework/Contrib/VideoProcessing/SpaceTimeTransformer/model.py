...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False,
                 qk_scale=None, attn_drop=0., proj_drop=0., with_qkv=True):
        super().__init__()
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
        ...
        # Classifier head
        self.head = nn.Linear(
            embed_dim, self.num_classes) if self.num_classes > 0 else nn.Identity()
...
if __name__ == '__main__':
    model = VisionTransformer(img_size=64, patch_size=8, in_chans=96,
                              ...
                              qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                              drop_path_rate=0.1, norm_layer=nn.LayerNorm,
                              num_frames=48, attention_type='divided_space_time', dropout=0.)
    video = torch.randn(2, 96, 48, 64, 64)
    print(video.size())
